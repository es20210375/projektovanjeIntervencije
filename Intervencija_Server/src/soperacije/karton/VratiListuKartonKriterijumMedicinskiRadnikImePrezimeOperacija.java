 ...
 * @author Emilija
 */
public class VratiListuKartonKriterijumMedicinskiRadnikImePrezimeOperacija extends ApstraktnaGenerickaOperacija{
    ...
    protected void izvrsiOperaciju(Object objekat, String kljuc) throws Exception {
        ...
        String upit = " karton\n"
                ...
                + "WHERE medicinskiRadnik.ime LIKE '" + ime + "' AND medicinskiRadnik.prezime LIKE '"+prezime+"'";
