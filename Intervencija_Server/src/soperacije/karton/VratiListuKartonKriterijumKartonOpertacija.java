 ...
 * @author Emilija
 */
public class VratiListuKartonKriterijumKartonOpertacija extends ApstraktnaGenerickaOperacija {
    ...
    protected void izvrsiOperaciju(Object objekat, String kljuc) throws Exception {
        ...
        String upit = " karton\n"
                ...
                + "WHERE EXTRACT(YEAR FROM karton.datumOtvaranja) = " + godina;
