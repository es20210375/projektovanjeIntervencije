 ...
 * @author Emilija
 */
public class VratiPacijenteKriterijumImeOsiguranjeNeOperacija extends ApstraktnaGenerickaOperacija{
    List<Pacijent> pac;
    @Override
...
" WHERE pacijent.ime LIKE '"+ime+"' AND osiguranje.statusOsiguranja LIKE 'NE' ";
