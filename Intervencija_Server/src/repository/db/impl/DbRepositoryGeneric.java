...
public class DbRepositoryGeneric implements DbRepository<ApstraktniDomenskiObjekat> {
    ...
    @Override
    public ApstraktniDomenskiObjekat getById(ApstraktniDomenskiObjekat param,String uslov) throws Exception {
        String upit = "SELECT * FROM " + param.vratiNazivTabele();
        if (uslov != null) {
            upit += uslov;
        }
        ...
        ApstraktniDomenskiObjekat obj = param.vratiObjekatIzRs(rs);
